...
public class SignUp extends JPanel implements ActionListener, KeyListener{
	...
	// Instance variables for Sign Up Page
		...
		private JComboBox signUp_GradeCombo = null;
...
public SignUp(){
	...
	BoxLayout boxLayout = new BoxLayout(root_panel_inside_tabbedPane, BoxLayout.Y_AXIS);
...
//					root_panel_inside_tabbedPane, BoxLayout.Y_AXIS));
			...
			root_panel_inside_tabbedPane
					.setBorder(BorderFactory.createLineBorder((new Color(150,
							150, 150)), 3));
			...
			signUp_GradeCombo = new JComboBox(grades);
			...
			signUp_GradeCombo.addItemListener(new ItemListener() {
				...
				public void itemStateChanged(ItemEvent e) {
					...
					gradeFromComboBox = (String) signUp_GradeCombo.getSelectedItem() ;
		...
		public void actionPerformed(ActionEvent evt) {
			if (evt.getSource() == submitButton)
				this.checkSignUp();
				this.writeToFile(signup_FakeNameText, signUp_UserNameText, gradeFromComboBox);
		}
	...
	//m_grade = signUp_GradeCombo.getSelectedItem();
	 if ((m_grade == null) || (m_grade.equals(""))) {
		...
		JOptionPane.showMessageDialog(this, "Enter the User Name", "Error",
				JOptionPane.ERROR_MESSAGE);}
		else if((getFakeName == null) || getFakeName.equals("")){
...
private void writeToFile(JTextField fullNameText, JTextField userNameText, String grade ) {
